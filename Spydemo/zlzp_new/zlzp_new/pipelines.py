...
class ZlzpNewPipeline(object):
    def process_item(self, item, spider):
        return item



class zlzp_newPipeline(object):
    ...
    def process_item(self,item,spider):
        try:
            for each in item:
                ...
                cursor = db.cursor()
                sql = "INSERT INTO zlzp_new (name,gz,gzdd,gsxz,gsgm,xl,bz,href) VALUES ('%s','%s','%s','%s','%s','%s','%s','%s')" % (
        ...
        print 'The end of the Parser Work,the spider Worked for %s Hours'
